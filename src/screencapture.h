...
// Forward declaration for memory pool (defined in memory_pool/MemoryPool.h)
class MemoryPool;
...
namespace ScreenCapture {
    ...
    // Memory pool access - provides reusable buffers for capture operations
    // MemoryPool is defined at global scope in memory_pool/MemoryPool.h
