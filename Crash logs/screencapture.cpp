...
CaptureResult CaptureScreen(const CaptureParams& params) {
    ...
    try {
        ...
        if (FAILED(hr)) {
            result.success = false;
            result.message = "Failed to setup desktop duplication: HRESULT " + std::to_string(static_cast<uint32_t>(hr));
            return result;
        }
        ...
        if (FAILED(hr)) {
            result.success = false;
            result.message = "Failed to capture frame: HRESULT " + std::to_string(static_cast<uint32_t>(hr));
            return result;
        }
        ...
        if (FAILED(hr)) {
            result.success = false;
            result.message = "Failed to save image: HRESULT " + std::to_string(static_cast<uint32_t>(hr));
            return result;
        }
...
CaptureResult CaptureGIF(const CaptureParams& params) {
    ...
    try {
        ...
        if (FAILED(hr)) {
            CleanupTempDirectory(tempDir, tempFrameFiles);
            result.success = false;
            result.message = "Failed to setup desktop duplication for GIF: HRESULT " + std::to_string(static_cast<uint32_t>(hr));
            return result;
        }
        ...
        for (int frame = 0; frame < totalFrames; ++frame) {
            ...
            if (FAILED(hr)) {
                CleanupTempDirectory(tempDir, tempFrameFiles);
                result.success = false;
                result.message = "Failed to capture GIF frame: HRESULT " + std::to_string(static_cast<uint32_t>(hr));
                return result;
            }
            ...
            if (FAILED(hr)) {
                CleanupTempDirectory(tempDir, tempFrameFiles);
                result.success = false;
                result.message = "Failed to save temp frame to disk: HRESULT " + std::to_string(static_cast<uint32_t>(hr));
                return result;
            }
   ...
   if (tempFrameFiles.empty()) {
        ...
        if (SUCCEEDED(hr)) {
            ...
            result.success = false;
            result.message = "COM initialization failed for GIF encoder: HRESULT " + std::to_string(static_cast<uint32_t>(hr));
            return result;
        }
        ...
        if (FAILED(hr)) {
            if (comInitialized) CoUninitialize();
            result.success = false;
            result.message = "Failed to create WIC factory: HRESULT " + std::to_string(static_cast<uint32_t>(hr));
            return result;
        }
        ...
        if (FAILED(hr)) {
            if (comInitialized) CoUninitialize();
            result.success = false;
            result.message = "Failed to create WIC stream: HRESULT " + std::to_string(static_cast<uint32_t>(hr));
            return result;
        }
        ...
        if (FAILED(hr)) {
            if (comInitialized) CoUninitialize();
            result.success = false;
            result.message = "Failed to open output file for GIF: HRESULT " + std::to_string(static_cast<uint32_t>(hr));
            return result;
        }
        ...
        if (FAILED(hr)) {
            if (comInitialized) CoUninitialize();
            result.success = false;
            result.message = "Failed to create GIF encoder: HRESULT " + std::to_string(static_cast<uint32_t>(hr));
            return result;
        }
        ...
        if (FAILED(hr)) {
            if (comInitialized) CoUninitialize();
            result.success = false;
            result.message = "Failed to initialize GIF encoder: HRESULT " + std::to_string(static_cast<uint32_t>(hr));
            return result;
        }
        ...
        for (size_t i = 0; i < tempFrameFiles.size(); ++i) {
            ...
            if (FAILED(hr)) {
                ...
                if (comInitialized) CoUninitialize();
                result.success = false;
                result.message = "Failed to load temp frame from disk: HRESULT " + std::to_string(static_cast<uint32_t>(hr));
                return result;
            }
            ...
            full_frame_encoding:
                ...
                if (!wicBitmap) {
                    ...
                    if (FAILED(hr)) {
                        ...
                        if (comInitialized) CoUninitialize();
                        result.success = false;
                        result.message = "Failed to create WIC bitmap from frame: HRESULT " + std::to_string(static_cast<uint32_t>(hr));
                        return result;
                    }
            ...
            if (FAILED(hr)) {
                ...
                if (comInitialized) CoUninitialize();
                result.success = false;
                result.message = "Failed to create GIF frame encoder: HRESULT " + std::to_string(static_cast<uint32_t>(hr));
                return result;
            }
            ...
            if (FAILED(hr)) {
                ...
                if (comInitialized) CoUninitialize();
                result.success = false;
                result.message = "Failed to initialize GIF frame: HRESULT " + std::to_string(static_cast<uint32_t>(hr));
                return result;
            }
            ...
            if (FAILED(hr)) {
                ...
                if (comInitialized) CoUninitialize();
                result.success = false;
                result.message = "Failed to write GIF frame: HRESULT " + std::to_string(static_cast<uint32_t>(hr));
                return result;
            }
            ...
            if (FAILED(hr)) {
                ...
                if (comInitialized) CoUninitialize();
                result.success = false;
                result.message = "Failed to commit GIF frame: HRESULT " + std::to_string(static_cast<uint32_t>(hr));
                return result;
            }
        ...
        if (FAILED(hr)) {
            ...
            if (comInitialized) CoUninitialize();
            result.success = false;
            result.message = "Failed to commit GIF encoder: HRESULT " + std::to_string(static_cast<uint32_t>(hr));
            return result;
        }
...
static std::wstring CreateAPNGTempDirectory(const std::wstring& basePath) {
    ...
    try {
        ...
        if (FAILED(hr)) {
            CleanupTempDirectory(tempDir, tempFrameFiles);
            result.success = false;
            result.message = "Failed to setup desktop duplication for APNG: HRESULT " + std::to_string(static_cast<uint32_t>(hr));
            return result;
        }
        ...
        for (int frame = 0; frame < totalFrames; ++frame) {
            ...
            if (FAILED(hr)) {
                CleanupTempDirectory(tempDir, tempFrameFiles);
                result.success = false;
                result.message = "Failed to capture APNG frame: HRESULT " + std::to_string(static_cast<uint32_t>(hr));
                return result;
            }
            ...
            if (FAILED(hr)) {
                CleanupTempDirectory(tempDir, tempFrameFiles);
                result.success = false;
                result.message = "Failed to save temp APNG frame to disk: HRESULT " + std::to_string(static_cast<uint32_t>(hr));
                return result;
            }
...
logger::info("All {} frames captured to disk, starting APNG encoding...", tempFrameFiles.size());
        ...
        if (SUCCEEDED(hr)) {
            ...
            CleanupTempDirectory(tempDir, tempFrameFiles);
            result.success = false;
            result.message = "COM initialization failed for APNG encoder: HRESULT " + std::to_string(static_cast<uint32_t>(hr));
            return result;
        }
        ...
        if (FAILED(hr)) {
            ...
            if (comInitialized) CoUninitialize();
            result.success = false;
            result.message = "Failed to create WIC factory for APNG: HRESULT " + std::to_string(static_cast<uint32_t>(hr));
            return result;
        }
        ...
        if (FAILED(hr)) {
            ...
            if (comInitialized) CoUninitialize();
            result.success = false;
            result.message = "Failed to load first APNG frame: HRESULT " + std::to_string(static_cast<uint32_t>(hr));
            return result;
        }
        ...
        if (FAILED(hr)) {
            ...
            if (comInitialized) CoUninitialize();
            result.success = false;
            result.message = "Failed to encode first frame as PNG: HRESULT " + std::to_string(static_cast<uint32_t>(hr));
            return result;
        }

        // Store previous frame pixels for differential comparison
        std::vector<uint8_t> prevFramePixels;
        size_t prevRowPitch = 0;

        if (useDifferentialEncoding) {
            prevRowPitch = firstImg->rowPitch;
            prevFramePixels.resize(fullHeight * prevRowPitch);
            memcpy(prevFramePixels.data(), firstImg->pixels, prevFramePixels.size());
        }
        ...
        for (size_t i = 1; i < tempFrameFiles.size(); ++i) {
            ...
            // ================================================================
            if (useDifferentialEncoding && !prevFramePixels.empty()) {
                uint32_t diffLeft, diffTop, diffRight, diffBottom;

                bool hasChanges = ComputeAPNGDiffRect(
                    prevFramePixels.data(), prevRowPitch,
                ...
                memcpy(prevFramePixels.data(), img->pixels, fullHeight * img->rowPitch);
            }
            else {
